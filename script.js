...
const elementTranslations = [
  ...
  ['.hero h1', ['Move with purpose.<br>Record every <em>moment.</em>']],
  ['.hero .intro', ['When you move, recording begins. When you stop, it wraps up.<br class="desktop"> Relive your route and speed with mOmentiOn.']],
  ...
  ['.showcase-copy h3', ['Your ride moves.<br>Recording follows.', 'Route and speed,<br>together.', 'See how every<br>moment connects.', 'Same road.<br>Different moments.']],
  ['.showcase-copy > p:last-child', ['Set start and stop speeds, and mOmentiOn controls the connected camera using GPS speed.', 'Review your route, time, distance, and speed in one place.', 'Match heatmap positions with graph values to understand the flow of your ride.', 'Compare speed and elapsed time across multiple rides.']],
